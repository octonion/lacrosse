...
drop table if exists mll._schedule_factors;

create table mll._schedule_factors (
        team_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
