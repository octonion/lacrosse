...
drop table if exists ncaa_women._schedule_factors;

create table ncaa_women._schedule_factors (
        team_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
...
strength=o.strength
from ncaa_women._schedule_factors o
