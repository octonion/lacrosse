...
drop table if exists ncaa_women.results;

create table ncaa_women.results (
	pulled_id	      integer,
	game_id		      integer,
	game_date	      date,
	year		      integer,
...
insert into ncaa_women.results
(pulled_id,
...
update ncaa_women.results
set team_div_id=sd.div_id
from ncaa_women.teams_divisions sd
