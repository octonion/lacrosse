...
dbWriteTable(con,c("ncaa_women","_parameter_levels"),parameter_levels,row.names=TRUE)
...
dbWriteTable(con,c("ncaa_women","_basic_factors"),as.data.frame(combined),row.names=TRUE)
