...
drop table if exists ncaa_women.rounds_d3;

create table ncaa_women.rounds_d3 (
	year				integer,
	round_id			integer,
	seed				integer,
	division_id			integer,
...
copy ncaa_women.rounds_d3 from '/tmp/rounds.csv' with delimiter as ',' csv header quote as '"';

-- matchup probabilities

drop table if exists ncaa_women.matrix_p_d3;

create table ncaa_women.matrix_p_d3 (
	year				integer,
	field				text,
	team_id				integer,
	opponent_id			integer,
...
insert into ncaa_women.matrix_p_d3
...
((v.strength*d.exp_factor)^3.2+(h.strength*o.exp_factor)^3.2)
  as visitor_p
from ncaa_women.rounds_d3 r1
join ncaa_women.rounds_d3 r2
...
drop table if exists ncaa_women.matrix_field_d3;

create table ncaa_women.matrix_field_d3 (
	year				integer,
	round_id			integer,
	team_id				integer,
	opponent_id			integer,
...
insert into ncaa_women.matrix_field_d3
...
update ncaa_women.matrix_field_d3
set field='home'
from ncaa_women.rounds_d3 rt, ncaa_women.rounds_d3 ro
where
    (rt.year,rt.team_id)=
...
and rt.round_id=1
and ro.round_id=1
and matrix_field_d3.round_id between 3 and 5
and rt.seed < ro.seed;
