...
#division=1&sportCode=MLA&academicYear=2017&doWhat=listSchools&rankSeq=17777'

root_url = 'http://web1.ncaa.org/stats/StatsSrv/ranksummary?regionIdx=&conferenceIdx=&schoolIdx=&confId=&orgId=&regionId=&userCustomId=&ncaaCustomId=&rankSummaryType=&sportCode=MLA'
...
weekly.each do |week|
  ...
  url = base_url+"division=#{div}&sportCode=MLA&academicYear=#{year}&doWhat=listSchools&rankSeq=#{rid}"
