...
drop table if exists nll._schedule_factors;

create table nll._schedule_factors (
        team_id		integer,
	year			integer,
        offensive               float,
        defensive		float,
